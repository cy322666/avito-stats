...
class Moves extends Base
{
    ...
    public function all(int $limit, int $offset = 100)
    {
        $array = [];
    ...
    {
        $response = Http::withHeaders($this->getHeaders())->get('https://online.moysklad.ru/api/remap/1.2/entity/move/'.$id.'/positions');
